...
-
**embeddingConfig**– Contains an`outputEmbeddingLength`

field, in which you specify one of the following lengths for the output embeddings vector.-
256
...
of the response contains the following fields.`{ "embedding": [float, float, ...], "inputTextTokenCount": int, "message": string }`
