---
source_url: https://azure.github.io/azure-sdk-for-python/index.html
fetched_at: 2026-01-25T11:49:09.441078
---
...
[Client - New Releases](#client-new-releases)[Client - Previous Versions](#client-previous-versions)[Management - New Releases](#management-new-releases)[Management - Previous Versions](#management-previous-versions)
...
Management libraries can be identified by namespaces that start with `azure-mgmt-`
...
[Azure SDK for Python documentation](https://aka.ms/python-docs) - File an issue via
[GitHub Issues](https://github.com/Azure/azure-sdk-for-python/issues) - Check
[previous questions](https://stackoverflow.com/questions/tagged/azure+python)or ask new ones on StackOverflow using`azure`
...
To opt out, you can disable telemetry at client construction. Define a `NoUserAgentPolicy`

class that is a subclass of `UserAgentPolicy`

with an `on_request`

method that does nothing. Then pass instance of this class as kwargs `user_agent_policy=NoUserAgentPolicy()`

during client creation. This will disable telemetry for all methods in the client. Do this for every new client.

The example below uses the `azure-storage-blob`

package. In your code, you can replace `azure-storage-blob`
