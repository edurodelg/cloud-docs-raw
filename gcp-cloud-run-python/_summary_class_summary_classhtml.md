---
merged_at: 2026-01-25T12:20:14.968058
merged_files: 2
---
...
<!-- DOCUMENTO FUSIONADO: summary_class.md -->
<!-- URL ORIGINAL: https://cloud.google.com/python/docs/reference/run/latest/summary_class -->
...
[BuildsAsyncClient](/python/docs/reference/run/latest/google.cloud.run_v2.services.builds.BuildsAsyncClient)

Cloud Run Build Control Plane API

[BuildsClient](/python/docs/reference/run/latest/google.cloud.run_v2.services.builds.BuildsClient)

Cloud Run Build Control Plane API

[ExecutionsAsyncClient](/python/docs/reference/run/latest/google.cloud.run_v2.services.executions.ExecutionsAsyncClient)

Cloud Run Execution Control Plane API.

[ExecutionsClient](/python/docs/reference/run/latest/google.cloud.run_v2.services.executions.ExecutionsClient)
...
[JobsAsyncClient](/python/docs/reference/run/latest/google.cloud.run_v2.services.jobs.JobsAsyncClient)

Cloud Run Job Control Plane API.

[JobsClient](/python/docs/reference/run/latest/google.cloud.run_v2.services.jobs.JobsClient)
...
[RevisionsAsyncClient](/python/docs/reference/run/latest/google.cloud.run_v2.services.revisions.RevisionsAsyncClient)

Cloud Run Revision Control Plane API.

[RevisionsClient](/python/docs/reference/run/latest/google.cloud.run_v2.services.revisions.RevisionsClient)
...
[ServicesAsyncClient](/python/docs/reference/run/latest/google.cloud.run_v2.services.services.ServicesAsyncClient)

Cloud Run Service Control Plane API

[ServicesClient](/python/docs/reference/run/latest/google.cloud.run_v2.services.services.ServicesClient)
...
[TasksAsyncClient](/python/docs/reference/run/latest/google.cloud.run_v2.services.tasks.TasksAsyncClient)

Cloud Run Task Control Plane API.

[TasksClient](/python/docs/reference/run/latest/google.cloud.run_v2.services.tasks.TasksClient)
...
[WorkerPoolsAsyncClient](/python/docs/reference/run/latest/google.cloud.run_v2.services.worker_pools.WorkerPoolsAsyncClient)

Cloud Run WorkerPool Control Plane API.

[WorkerPoolsClient](/python/docs/reference/run/latest/google.cloud.run_v2.services.worker_pools.WorkerPoolsClient)
...
[EnvironmentVariablesEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.BuildConfig.EnvironmentVariablesEntry)
...
[CommonReason](/python/docs/reference/run/latest/google.cloud.run_v2.types.Condition.CommonReason)

Reasons common to all types of conditions.

[ExecutionReason](/python/docs/reference/run/latest/google.cloud.run_v2.types.Condition.ExecutionReason)

Reasons specific to Execution resource.

[RevisionReason](/python/docs/reference/run/latest/google.cloud.run_v2.types.Condition.RevisionReason)

Reasons specific to Revision resource.

[Severity](/python/docs/reference/run/latest/google.cloud.run_v2.types.Condition.Severity)

Represents the severity of the condition failures.

[State](/python/docs/reference/run/latest/google.cloud.run_v2.types.Condition.State)
...
[Medium](/python/docs/reference/run/latest/google.cloud.run_v2.types.EmptyDirVolumeSource.Medium)
...
[AnnotationsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.Execution.AnnotationsEntry)

The abstract base class for a message.

[LabelsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.Execution.LabelsEntry)
...
[CompletionStatus](/python/docs/reference/run/latest/google.cloud.run_v2.types.ExecutionReference.CompletionStatus)
...
[AnnotationsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.ExecutionTemplate.AnnotationsEntry)

The abstract base class for a message.

[LabelsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.ExecutionTemplate.LabelsEntry)
...
[AnnotationsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.Job.AnnotationsEntry)

The abstract base class for a message.

[LabelsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.Job.LabelsEntry)
...
[LimitsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.ResourceRequirements.LimitsEntry)
...
[AnnotationsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.Revision.AnnotationsEntry)

The abstract base class for a message.

[LabelsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.Revision.LabelsEntry)
...
[AnnotationsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.RevisionTemplate.AnnotationsEntry)

The abstract base class for a message.

[LabelsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.RevisionTemplate.LabelsEntry)
...
[Overrides](/python/docs/reference/run/latest/google.cloud.run_v2.types.RunJobRequest.Overrides)

RunJob Overrides that contains Execution fields to be overridden.

[ContainerOverride](/python/docs/reference/run/latest/google.cloud.run_v2.types.RunJobRequest.Overrides.ContainerOverride)
...
[AnnotationsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.Service.AnnotationsEntry)

The abstract base class for a message.

[LabelsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.Service.LabelsEntry)

The abstract base class for a message.

[MultiRegionSettings](/python/docs/reference/run/latest/google.cloud.run_v2.types.Service.MultiRegionSettings)
...
[ScalingMode](/python/docs/reference/run/latest/google.cloud.run_v2.types.ServiceScaling.ScalingMode)
...
[CloudStorageSource](/python/docs/reference/run/latest/google.cloud.run_v2.types.SourceCode.CloudStorageSource)
...
[BuildpacksBuild](/python/docs/reference/run/latest/google.cloud.run_v2.types.SubmitBuildRequest.BuildpacksBuild)

Build the source using Buildpacks.

[EnvironmentVariablesEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.SubmitBuildRequest.BuildpacksBuild.EnvironmentVariablesEntry)

The abstract base class for a message.

[DockerBuild](/python/docs/reference/run/latest/google.cloud.run_v2.types.SubmitBuildRequest.DockerBuild)
...
[AnnotationsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.Task.AnnotationsEntry)

The abstract base class for a message.

[LabelsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.Task.LabelsEntry)
...
[NetworkInterface](/python/docs/reference/run/latest/google.cloud.run_v2.types.VpcAccess.NetworkInterface)

Direct VPC egress settings.

[VpcEgress](/python/docs/reference/run/latest/google.cloud.run_v2.types.VpcAccess.VpcEgress)
...
[AnnotationsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.WorkerPool.AnnotationsEntry)

The abstract base class for a message.

[LabelsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.WorkerPool.LabelsEntry)
...
[AnnotationsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.WorkerPoolRevisionTemplate.AnnotationsEntry)

The abstract base class for a message.

[LabelsEntry](/python/docs/reference/run/latest/google.cloud.run_v2.types.WorkerPoolRevisionTemplate.LabelsEntry)
...
[pagers](/python/docs/reference/run/latest/google.cloud.run_v2.services.jobs.pagers)

API documentation for `run_v2.services.jobs.pagers`

module.

[pagers](/python/docs/reference/run/latest/google.cloud.run_v2.services.revisions.pagers)

API documentation for `run_v2.services.revisions.pagers`

module.

[pagers](/python/docs/reference/run/latest/google.cloud.run_v2.services.services.pagers)

API documentation for `run_v2.services.services.pagers`

module.

[pagers](/python/docs/reference/run/latest/google.cloud.run_v2.services.tasks.pagers)

API documentation for `run_v2.services.tasks.pagers`

module.

[pagers](/python/docs/reference/run/latest/google.cloud.run_v2.services.worker_pools.pagers)
...
<!-- DOCUMENTO FUSIONADO: summary_classhtml.md -->
<!-- URL ORIGINAL: https://cloud.google.com/python/docs/reference/run/latest/summary_class.html -->
