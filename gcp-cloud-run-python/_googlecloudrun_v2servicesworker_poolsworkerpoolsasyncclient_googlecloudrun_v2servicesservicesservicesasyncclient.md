---
merged_at: 2026-01-25T12:20:14.968829
merged_files: 2
---
...
<!-- DOCUMENTO FUSIONADO: googlecloudrun_v2servicesworker_poolsworkerpoolsasyncclient.md -->
<!-- URL ORIGINAL: https://cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.worker_pools.WorkerPoolsAsyncClient -->

# Class WorkerPoolsAsyncClient (0.14.0)
...
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the WorkerPoolsTransport constructor. If set to None, a transport is chosen automatically. |
`client_options` |
...
# Create a client
client = [run_v2](https://docs.cloud.google.com/python/docs/reference/run/latest).[WorkerPoolsAsyncClient](https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.worker_pools.WorkerPoolsAsyncClient.html)()
...
# Make the request
operation = client.[create_worker_pool](https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.worker_pools.WorkerPoolsAsyncClient.html#google_cloud_run_v2_services_worker_pools_WorkerPoolsAsyncClient_create_worker_pool)(request=request)
...
# Make the request
operation = client.[delete_worker_pool](https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.worker_pools.WorkerPoolsAsyncClient.html#google_cloud_run_v2_services_worker_pools_WorkerPoolsAsyncClient_delete_worker_pool)(request=request)
print("Waiting for operation to complete...")
response = (await operation).result()
# Handle the response
print(response)
...
# Make the request
response = await client.[get_iam_policy](https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.worker_pools.WorkerPoolsAsyncClient.html#google_cloud_run_v2_services_worker_pools_WorkerPoolsAsyncClient_get_iam_policy)(request=request)
# Handle the response
print(response)
...
# Make the request
response = await client.[get_worker_pool](https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.worker_pools.WorkerPoolsAsyncClient.html#google_cloud_run_v2_services_worker_pools_WorkerPoolsAsyncClient_get_worker_pool)(request=request)
# Handle the response
print(response)
...
# Make the request
page_result = client.[list_worker_pools](https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.worker_pools.WorkerPoolsAsyncClient.html#google_cloud_run_v2_services_worker_pools_WorkerPoolsAsyncClient_list_worker_pools)(request=request)
# Handle the response
...
# Make the request
response = await client.[set_iam_policy](https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.worker_pools.WorkerPoolsAsyncClient.html#google_cloud_run_v2_services_worker_pools_WorkerPoolsAsyncClient_set_iam_policy)(request=request)
# Handle the response
print(response)
...
# Make the request
response = await client.[test_iam_permissions](https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.worker_pools.WorkerPoolsAsyncClient.html#google_cloud_run_v2_services_worker_pools_WorkerPoolsAsyncClient_test_iam_permissions)(request=request)
# Handle the response
print(response)
...
# Make the request
operation = client.[update_worker_pool](https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.worker_pools.WorkerPoolsAsyncClient.html#google_cloud_run_v2_services_worker_pools_WorkerPoolsAsyncClient_update_worker_pool)(request=request)
print("Waiting for operation to complete...")
response = (await operation).result()
# Handle the response
print(response)
...
<!-- DOCUMENTO FUSIONADO: googlecloudrun_v2servicesservicesservicesasyncclient.md -->
<!-- URL ORIGINAL: https://cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.services.ServicesAsyncClient -->

# Class ServicesAsyncClient (0.14.0)
...
# Create a client
client = [run_v2](https://docs.cloud.google.com/python/docs/reference/run/latest).[ServicesAsyncClient](https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.services.ServicesAsyncClient.html)()
# Initialize request argument(s)
...
# Make the request
operation = client.[create_service](https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.services.ServicesAsyncClient.html#google_cloud_run_v2_services_services_ServicesAsyncClient_create_service)(request=request)
print("Waiting for operation to complete...")
response = (await operation).result()
# Handle the response
print(response)
...
# Make the request
operation = client.[delete_service](https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.services.ServicesAsyncClient.html#google_cloud_run_v2_services_services_ServicesAsyncClient_delete_service)(request=request)
print("Waiting for operation to complete...")
response = (await operation).result()
# Handle the response
print(response)
...
# Make the request
response = await client.[get_iam_policy](https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.services.ServicesAsyncClient.html#google_cloud_run_v2_services_services_ServicesAsyncClient_get_iam_policy)(request=request)
# Handle the response
print(response)
...
# Make the request
response = await client.[get_service](https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.services.ServicesAsyncClient.html#google_cloud_run_v2_services_services_ServicesAsyncClient_get_service)(request=request)
# Handle the response
print(response)
...
# Make the request
page_result = client.[list_services](https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.services.ServicesAsyncClient.html#google_cloud_run_v2_services_services_ServicesAsyncClient_list_services)(request=request)
# Handle the response
async for response in page_result:
print(response)
...
# Make the request
response = await client.[set_iam_policy](https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.services.ServicesAsyncClient.html#google_cloud_run_v2_services_services_ServicesAsyncClient_set_iam_policy)(request=request)
# Handle the response
print(response)
...
# Make the request
response = await client.[test_iam_permissions](https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.services.ServicesAsyncClient.html#google_cloud_run_v2_services_services_ServicesAsyncClient_test_iam_permissions)(request=request)
# Handle the response
print(response)
...
# Make the request
operation = client.[update_service](https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.services.ServicesAsyncClient.html#google_cloud_run_v2_services_services_ServicesAsyncClient_update_service)(request=request)
print("Waiting for operation to complete...")
response = (await operation).result()
# Handle the response
print(response)
