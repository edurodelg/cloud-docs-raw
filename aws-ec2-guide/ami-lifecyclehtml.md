...
fetched_at: 2026-02-04T00:10:10.189193
---
...
instance attestation, see [Attestable AMIs](./attestable-ami.html).
...
Amazon Data Lifecycle Manager](https://docs.aws.amazon.com/ebs/latest/userguide/snapshot-lifecycle.html) in the *Amazon EBS User Guide* and the
[EC2
Image Builder User Guide](https://docs.aws.amazon.com/imagebuilder/latest/userguide/what-is-image-builder.html).