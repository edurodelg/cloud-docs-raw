...
fetched_at: 2026-02-08T00:51:02.217726
---
...
uses an [S3 multipart upload](https://docs.aws.amazon.com/AmazonS3/latest/userguide/mpuoverview.html) to store the data in an S3 object. The API takes
...
can view the progress of the task by describing the AMI ([describe-images](https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-images.html)) or
its EBS snapshots ([describe-snapshots](https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-snapshots.html)). If the task fails, the AMI and snapshots are moved
to a failed state.
...
`path1/path2/ami-0abcdef1234567890`

.bin


When you restore the AMI, you specify both the bucket name and the object
key. For examples, see [Create a store image task](./work-with-ami-store-restore.html#create-store-image-task).