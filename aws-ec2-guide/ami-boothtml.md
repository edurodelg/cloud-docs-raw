---
source_url: https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ami-boot.html
fetched_at: 2026-01-25T11:55:52.382001
---
...
instance. When the boot mode parameter is set to `uefi`
...
You can create AMIs that support both UEFI and Legacy BIOS by using the `uefi-preferred`

boot mode parameter.
When the boot mode parameter is set to `uefi-preferred`

, and if the instance type supports UEFI, the instance
...
When you use the `uefi-preferred`

AMI boot mode parameter with an
