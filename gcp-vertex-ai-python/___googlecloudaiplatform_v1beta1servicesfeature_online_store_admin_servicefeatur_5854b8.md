---
merged_at: 2026-01-28T15:11:44.743789
merged_files: 2
---
...
# Class WorkbenchRuntime (1.135.0)
...
# Class CreateFeatureMonitorJobRequest (1.135.0)
...
# Class ExplanationSpecOverride (1.135.0)
...
# Class SearchModelMonitoringAlertsResponse (1.135.0)
...
# Class SimilaritySearchParams (1.135.0)
...
# Class ExactMatchMetricValue (1.135.0)
...
# Class FeaturestoreOnlineServingServiceAsyncClient (1.135.0)
...
# Class DirectUploadSource (1.135.0)
...
# Class CreatePipelineJobRequest (1.135.0)
...
# Class RemoveDatapointsResponse (1.135.0)
...
# Class UpsertDatapointsResponse (1.135.0)
...
# Class FeatureNoiseSigma (1.135.0)
...
# Class GoogleServiceAccountConfig (1.135.0)
...
# Class CreateModelMonitorRequest (1.135.0)
...
# Class EvaluatedAnnotationType (1.135.0)
...
# Class UpdateNotebookRuntimeTemplateRequest (1.135.0)
...
# Package schedule_service (1.135.0)
...
# Class SearchModelDeploymentMonitoringStatsAnomaliesRequest (1.135.0)
...
# Class TextTransformation (1.135.0)
...
# Class UpdateModelDeploymentMonitoringJobRequest (1.135.0)
...
# Class PointwiseMetricSpec (1.135.0)
...
# Class ModelDeploymentMonitoringObjectiveType (1.135.0)
...
# Class StoredContentsExampleParameters (1.135.0)
...
# Class AutoscalingMetricSpec (1.135.0)
...
# Class ImageSegmentationPredictionInstance (1.135.0)
...
# Class UserActionReference (1.135.0)
...
# Package deployment_resource_pool_service (1.135.0)
...
# Class AutoMlTextSentimentInputs (1.135.0)
...
# Class StoredContentsExampleFilter (1.135.0)
...
# Class SpeculativeDecodingSpec (1.135.0)
...
# Class ModelMonitoringStats (1.135.0)
...
# Class ArtifactTypeSchema (1.135.0)
...
# Class ListFeatureMonitorsRequest (1.135.0)
...
# Class SampledShapleyAttribution (1.135.0)
...
# Class RagManagedDbConfig (1.135.0)
...
|
`serverless` |
Sets the backend to be the serverless mode offered by RAG Engine. This field is a member of `oneof` _ `mode` .
|
`spanner` |
Sets the RAG Engine backend to be RagManagedDb, built on top of Spanner. NOTE: This is the default mode (w/ Basic Tier) if not explicitly chosen. This field is a member of `oneof` _ `mode` .
|
...
# Class ToolCallValidMetricValue (1.135.0)
...
# Class ToolNameMatchMetricValue (1.135.0)
