---
merged_at: 2026-01-28T15:11:44.795434
merged_files: 2
---
...
# Class BatchMigrateResourcesResponse (1.135.0)
...
# Class TrajectoryInOrderMatchResults (1.135.0)
...
# Class AssessDataResponse (1.135.0)
...
# Class ReadTensorboardBlobDataResponse (1.135.0)
...
# Class ListDatasetsAsyncPager (1.135.0)
...
# Class ListEntityTypesPager (1.135.0)
...
# Class ListRagCorporaPager (1.135.0)
...
# Class ExportDataRequest (1.135.0)
...
# Class CreateNasJobRequest (1.135.0)
...
# Package definition_v1.types (1.135.0)
...
# Class ListContextsAsyncPager (1.135.0)
...
# Class DeleteSessionRequest (1.135.0)
...
# Class ListTensorboardsPager (1.135.0)
...
# Class FetchExamplesPager (1.135.0)
...
# Class RubricBasedInstructionFollowingInstance (1.135.0)
...
# Class CategoricalValueSpec (1.135.0)
...
# Class StreamDirectPredictResponse (1.135.0)
...
# Class CreateRegistryFeatureOperationMetadata (1.135.0)
...
# Class ModelExplanation (1.135.0)
...
# Class ModelContainerSpec (1.135.0)
...
# Class ImportExtensionOperationMetadata (1.135.0)
...
# Class GetExecutionRequest (1.135.0)
...
# Class GetDataLabelingJobRequest (1.135.0)
...
# Class CancelPipelineJobRequest (1.135.0)
...
# Class ListTensorboardsRequest (1.135.0)
...
# Class ClientConnectionConfig (1.135.0)
...
# Class CreateSessionOperationMetadata (1.135.0)
...
# Class ListEventsAsyncPager (1.135.0)
...
# Package prediction_v1beta1.types (1.135.0)
...
# Class GetExampleStoreRequest (1.135.0)
...
# Class GetFeatureOnlineStoreRequest (1.135.0)
...
# Class EvaluateInstancesResponse (1.135.0)
...
# Class CreateFeatureMonitorOperationMetadata (1.135.0)
...
# Class TrajectorySingleToolUseResults (1.135.0)
...
# Class ToolParameterKeyMatchInput (1.135.0)
...
# Class TrajectoryAnyOrderMatchResults (1.135.0)
...
# Class ListDataItemsResponse (1.135.0)
...
# Class ExecuteExtensionRequest (1.135.0)
...
# Class StopNotebookRuntimeOperationMetadata (1.135.0)
...
# Class CreateTrialRequest (1.135.0)
...
# Class DeleteMemoryRequest (1.135.0)
...
# Class CreateRagCorpusOperationMetadata (1.135.0)
...
# Class UpdateRagCorpusOperationMetadata (1.135.0)
...
# Class AutoMlForecastingInputs (1.135.0)
...
# Class ListSessionsAsyncPager (1.135.0)
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.types.GetRagEngineConfigRequest -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1beta1.types.GetModelMonitorRequest -->

# Class GetModelMonitorRequest (1.135.0)
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1beta1.types.GetFeatureOnlineStoreRequest -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.types.DeleteRagFileRequest -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.services.model_service.pagers.ListModelEvaluationsPager -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1beta1.services.vertex_rag_data_service.pagers.ListRagCorporaPager -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.services.metadata_service.pagers.ListMetadataSchemasPager -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.types.IndexDatapoint -->

# Class IndexDatapoint (1.135.0)
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.types.CheckTrialEarlyStoppingStateResponse -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1beta1.types.ListDataItemsResponse -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.services.match_service -->

# Package match_service (1.135.0)

API documentation for `aiplatform_v1.services.match_service`

package.

## Classes

[MatchServiceAsyncClient](/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.services.match_service.MatchServiceAsyncClient)

MatchService is a Google managed service for efficient vector similarity search at scale.

[MatchServiceClient](/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.services.match_service.MatchServiceClient)

MatchService is a Google managed service for efficient vector similarity search at scale.

---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1beta1.types.ToolParameterKeyMatchInput -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1beta1.services.metadata_service.pagers.ListContextsAsyncPager -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.types.ExportFeatureValuesOperationMetadata -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.types.UpdateEndpointOperationMetadata -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1beta1.types.SearchModelMonitoringAlertsRequest -->

# Class SearchModelMonitoringAlertsRequest (1.135.0)
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.types.SummarizationQualityInstance -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.types.GetMetadataStoreRequest -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1beta1.types.StopNotebookRuntimeOperationMetadata -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1beta1.types.CreateTrialRequest -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.types.ModelEvaluation.ModelEvaluationExplanationSpec -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1beta1.types.UpdateRagCorpusOperationMetadata -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1beta1.types.CreateRagCorpusOperationMetadata -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1beta1.services.tensorboard_service.pagers.ListTensorboardsPager -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.types.FeatureGroup -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.services.gen_ai_cache_service.pagers.ListCachedContentsPager -->

# Class ListCachedContentsPager (1.135.0)
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.types.DeleteTensorboardRequest -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.types.SummarizationQualitySpec -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1beta1.types.DeleteExampleStoreOperationMetadata -->

# Class DeleteExampleStoreOperationMetadata (1.135.0)
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.types.JiraSource -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1beta1.types.IndexDatapoint -->
...
---
<!-- Source: https://cloud.google.com/python/docs/reference/aiplatform/latest/google.cloud.aiplatform_v1.services.dataset_service.pagers.ListAnnotationsAsyncPager -->

# Class ListAnnotationsAsyncPager (1.135.0)
...
# Class CheckTrialEarlyStoppingStateResponse (1.134.0)
...
# Class GetMetadataStoreRequest (1.134.0)
...
# Class ModelEvaluationExplanationSpec (1.134.0)
...
# Class DeleteTensorboardRequest (1.134.0)
...
# Class SummarizationQualitySpec (1.134.0)
...
# Class DeleteExampleStoreOperationMetadata (1.134.0)
...
# Class UpdateExampleStoreOperationMetadata (1.134.0)
...
# Class UpdateFeatureMonitorOperationMetadata (1.134.0)
...
# Class CreateExampleStoreOperationMetadata (1.134.0)
...
# Class DeployedIndexRef (1.134.0)
...
# Class CreateDatasetRequest (1.134.0)
...
# Class TuningValidationAssessmentResult (1.134.0)
...
# Class DeleteExtensionRequest (1.134.0)
...
# Class TrajectoryPrecisionInput (1.134.0)
