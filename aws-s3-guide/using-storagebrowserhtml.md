---
source_url: https://docs.aws.amazon.com/AmazonS3/latest/userguide/using-storagebrowser.html
fetched_at: 2026-02-08T00:53:35.478678
---

# Using Storage Browser for S3

In Storage Browser for S3, a *location* is an S3 general purpose bucket or prefix, that you
grant end users access to using [S3 Access Grants](https://docs.aws.amazon.com/AmazonS3/latest/userguide/access-grants.html), IAM policies, or your
...
-
Storage Browser for S3 supports the

`PUT`

operation for files up to 160 GB in size. -
Storage Browser for S3 only supports the

`COPY`

operation for files smaller than 5 GB. If the file size exceeds 5 GB, Storage Browser fails the request.