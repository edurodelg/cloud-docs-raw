...
fetched_at: 2026-01-28T07:12:57.864450
---
...
You can determine the `Payer`

value that is set on a bucket by
...
-
Use a GET request to obtain the

`requestPayment`

resource, as shown in the following request.`GET ?requestPayment HTTP/1.1 Host:`
...
This response shows that the `payer`
