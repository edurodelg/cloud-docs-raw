...
fetched_at: 2026-01-25T12:20:02.767970
---
...
.
For more information about general purpose bucket naming rules, see [General purpose bucket naming rules](./bucketnamingrules.html).
...
[unique S3 prefixes](./using-prefixes.html) to organize the objects
...
encryption](./bucket-encryption.html), [S3 Versioning](./versioning-workflows.html), and
[S3 Requester Pays](./RequesterPaysBuckets.html) are set at the
...
settings for each dataset. Additionally, in a multi-tenant bucket, [cost allocation](./BucketBilling.html) can become complex as you work to
...
bucket encryption](./bucket-encryption.html), [S3 Versioning](./versioning-workflows.html),
and [S3 Requester Pays](./RequesterPaysBuckets.html) in a way that is
...
can use [AWS CloudFormation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html#welcome-simplify-infrastructure-management). You can create a custom CloudFormation template for your pattern that
already defines all of your desired settings for your S3 general purpose buckets so that you can easily
deploy and track any changes to your infrastructure. For more information, see [AWS::S3::Bucket](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-s3-bucket.html) in the *AWS CloudFormation User Guide*.