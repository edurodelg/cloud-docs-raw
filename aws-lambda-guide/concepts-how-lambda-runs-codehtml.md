...
fetched_at: 2026-01-28T07:04:04.767988
---
...
-
Lambda uses the runtime to prepare the event in a format your code can use.

-
The runtime sends the formatted event to your handler.

-
Your handler processes the event using the code you've written.
...
-
The runtime prepares both the event and DurableContext
...
-
**Initialization:**Environment setup and code loading -
**Invocation:**Single execution of function code -
**Shutdown:**Environment cleanup

**Durable Functions (up to 1 year):**

-
**Initialization:**Environment and durable state setup -
**Invocation:**Multiple steps with automatic checkpointing -
**Wait States:**Pause execution without resource consumption -
**Resume:**Restart from last checkpoint -
**Shutdown:**Cleanup of durable state

This environment handles important aspects of running your function. It provides your function with memory and a `/tmp`

directory for temporary storage. **For Durable Functions, it also manages:**
