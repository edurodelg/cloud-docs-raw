...
fetched_at: 2026-02-04T00:16:08.081802
---
...
July 17, 2025 |
| 2.6.0 |
Support table ARN as table name in DynamoDB APIs Performance fix and security updates |
|
March 13, 2025 |
| 2.5.4 |
...
|
November 6, 2024 |
| 2.5.2 | Bug fix for Update table workflow |
|
June 20, 2024 |
| 2.5.1 | Patch for bugs introduced in `OndemandThroughPut` feature |
|
June 5, 2024 |
| 2.5.0 |
...
| 1.25.1 |
Upgrading Jackson Dependencies to 2.17.x in Log4j Core (Resolves CVE-2022-1471) |
Upgrading Jackson Dependencies to 2.17.x in Log4j Core (Resolves CVE-2022-1471) to address a critical security vulnerability in the SnakeYAML library, which is a transitive dependency |
November 6, 2024 |
| 1.25.0 |
Added support for table deletion protection and the
|
