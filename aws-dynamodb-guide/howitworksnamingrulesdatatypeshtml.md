...
fetched_at: 2026-02-06T16:45:57.152553
---
...
[Data types](./Constraints.html#limits-data-types).
...
list, see [Reserved words in DynamoDB](./ReservedWords.html). Also,
...
in DynamoDB](./Expressions.ExpressionAttributeNames.html).
...
DynamoDB is a NoSQL database and is *schemaless*. This means that
...
represents 12:31:40 PM UTC on 17 July
2015.

For more information, see [http://en.wikipedia.org/wiki/Unix_time](http://en.wikipedia.org/wiki/Unix_time).
...
UTF-8 string encoding. For example, "`a`

" (0x61) is greater than
"`A`

" (0x41), and "`¿`

" (0xC2BF) is greater than
"`z`
...
For more information, see [http://en.wikipedia.org/wiki/ISO_8601](http://en.wikipedia.org/wiki/ISO_8601).
...
A Boolean type attribute can store either `true`
...
For more information, see [Attributes](./Constraints.html#limits-attributes).
...
those elements are deeply nested. For more information, see [Using expressions in DynamoDB](./Expressions.html).
...
The low-level DynamoDB API protocol uses *Data type descriptors* as
